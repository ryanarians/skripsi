...
(function (h) {
    ...
    function pb(a) {
        ...
        for (
            var f = a.sDom.split(""), g, j, i, l, m, q, k = 0;
            k < f.length;
            k++
        ) {
            g = null;
                ...
                for (g = b.length; e < g; e++)
                    (c = b[e]),
                        ...
                        i.indexOf &&
                            -1 !== i.indexOf("&") &&
                            ((wa.innerHTML = i),
                            (i = Xb ? wa.textContent : wa.innerText)),
    ...
    function Ha(a) {
        ...
        for (n = 0; n < i.length; n++)
            (o = c[i[n]]),
                null !== o.sWidth &&
                    ((o.sWidth = Gb(o.sWidthOrig, k)), (u = !0));
        if (d || (!u && !f && !e && j == W(a) && j == l.length))
            for (n = 0; n < j; n++)
                (i = ba(a, n)),
                    null !== i && (c[i].sWidth = w(l.eq(n).width()));
        else {
        ...
        for (a = 0; a < l.length; a++) {
            ...
            for (c = f.length; b < c; b++)
                (g = f[b]),
                    (j = e[g].sType || "string"),
                    l[a]._idx === k &&
                        (l[a]._idx = h.inArray(l[a][1], e[g].asSorting)),
                    d.push({
                        src: i,
                        col: g,
                        dir: l[a][1],
