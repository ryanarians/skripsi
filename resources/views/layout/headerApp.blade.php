...
<head>
    ...
    <link href="{{ asset('ladun/apaxy/') }}/css/style.css" rel="stylesheet" type="text/css" />
...
<body data-topbar="dark" nav data-layout="horizontal">

    <!-- Begin page -->
    <div id="layout-wrapper">


        <header id="page-topbar" class="warna-navy">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="index.html" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                ...
                                <h4 class="text-light">BAROKAH</h4>
                            </span>
                        </a>
                    </div>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-layout">
                                    <a href="javascript:void(0)" style="color: #152951" onclick="renderPage('app/produk/data', 'Produk')" class="dropdown-item">Data Produk</a>
                                    <a href="javascript:void(0)" style="color: #152951" onclick="renderPage('app/penjualan/data', 'Penjualan')" class="dropdown-item">Data Penjualan</a>
                                </div>
                            </li>
                            <li class="nav-item">
